...
<body>
  <div class="container">
    ...
    <div class="footer">
      ...
      <p><a href="mailto:valdirdesouzajunioradm@gmail.com">Contato</a> | <a href="http://localhost:1090/index.html">Nosso Site</a></p>
    </div>
  </div>
</body>
</html>`;
  ...
  private genarateLink(userOutputDTO: UserOutputDTO) {
    return `http://localhost:1090/verifyEmail/${this.token.generateTokenTimerSet(
      {
